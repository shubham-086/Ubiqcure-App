...
const HospitalInvoice = () => {
  ...
  const { hospitalBookingInfo, patient, setHospitalBookingInfo, setPatient } =
    useRepo();
  ...
  const getAppRequest = async () => {
    try {
      const response = await viewAppRequestDetails(
          ...
          <View className="my-2">
            <View className="mb-4 flex flex-row items-baseline border-dashed border-b border-gray-400">
              ...
              <Text className="text-2xl text-bold ml-4 mb-2">
                B{hospitalBookingInfo.slotNumber}
              </Text>
            </View>
            ...
            <View className="mb-4 flex flex-row items-baseline border-dashed border-b border-gray-400">
              ...
              <View className="ml-4 flex-1 flex flex-row justify-between mb-2">
                <Text className="text-lg">{hospitalBookingInfo.bookingId}</Text>
                <TouchableOpacity
                  activeOpacity={0.7}
                  className="bg-gray-200 border border-gray-200 py-1 px-2 rounded"
                  onPress={() =>
                    Clipboard.setStringAsync(hospitalBookingInfo.bookingId)
                  }
                >
